...
server.post('/login', auth_1.handlePartnerAuthentication);
server.post('/partner/login', auth_1.handlePartnerAuthentication);
server.get('/partner/profile/image/:imageName', getImages_1.handleGetProfileImage);
server.get('/partner/item/image/:imageName', menuItemImage_1.handleMenuItemGetImage);
