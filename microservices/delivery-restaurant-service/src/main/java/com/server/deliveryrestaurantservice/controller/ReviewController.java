...
public class ReviewController {
    ...
    public List<ReviewResponse> getReviewsByRestaurantId(@PathVariable Long restaurantId,
    ...
    public ReviewAverageResponse getRestaurantRatingAverage(@PathVariable Long restaurantId) {
